...
export class AutoProcessor {
     ...
     */
    static from_pretrained(pretrained_model_name_or_path: string, { progress_callback, config, cache_dir, local_files_only, revision, }?: import('@xenova/transformers/src/utils/hub.js').PretrainedOptions): Promise<Processor>;
}
/**
