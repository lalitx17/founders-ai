...
export class AutoConfig {
     ...
     * @returns {Promise<PretrainedConfig>} A new instance of the `PretrainedConfig` class.
     */
    static from_pretrained(pretrained_model_name_or_path: string, { progress_callback, config, cache_dir, local_files_only, revision, }?: import("@xenova/transformers/src/utils/hub.js").PretrainedOptions): Promise<PretrainedConfig>;
}
export type PretrainedOptions = import('@xenova/transformers/src/utils/hub.js').PretrainedOptions;
