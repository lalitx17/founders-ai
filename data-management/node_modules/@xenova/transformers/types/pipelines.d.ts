 ...
 */
export function pipeline<T extends PipelineType>(task: T, model?: string, { quantized, progress_callback, config, cache_dir, local_files_only, revision, model_file_name, }?: import('@xenova/transformers/src/utils/hub.js').PretrainedOptions): Promise<AllTasks[T]>;
...
export class Text2TextGenerationPipeline extends Text2TextGenerationPipeline_base {
    /** @type {'generated_text'} */
    _key: 'generated_text';
    _call(texts: string | string[], options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType): Promise<Text2TextGenerationOutput | Text2TextGenerationOutput[]>;
}
...
export class ImageToTextPipeline extends ImageToTextPipeline_base {
    _call(texts: ImagePipelineInputs, options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType): Promise<ImageToTextOutput | ImageToTextOutput[]>;
}
...
export class DocumentQuestionAnsweringPipeline extends DocumentQuestionAnsweringPipeline_base {
    _call(image: ImageInput, question: string, options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType): Promise<DocumentQuestionAnsweringOutput | DocumentQuestionAnsweringOutput[]>;
}
 ...
 */
export type Text2TextGenerationPipelineCallback = (texts: string | string[], options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType) => Promise<Text2TextGenerationOutput | Text2TextGenerationOutput[]>;
 ...
 */
export type SummarizationPipelineCallback = (texts: string | string[], options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType) => Promise<SummarizationOutput | SummarizationOutput[]>;
 ...
 */
export type TranslationPipelineCallback = (texts: string | string[], options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType) => Promise<TranslationOutput | TranslationOutput[]>;
export type TranslationPipelineType = TextPipelineConstructorArgs & TranslationPipelineCallback & Disposable;
export type Chat = import('@xenova/transformers/src/tokenizers.js').Message[];
...
export type TextGenerationConfig = import('@xenova/transformers/src/utils/generation.js').GenerationConfigType & TextGenerationSpecificParams;
/**
...
export type AutomaticSpeechRecognitionConfig = import('@xenova/transformers/src/utils/generation.js').GenerationConfigType & AutomaticSpeechRecognitionSpecificParams;
/**
 ...
 */
export type ImageToTextPipelineCallback = (texts: ImagePipelineInputs, options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType) => Promise<ImageToTextOutput | ImageToTextOutput[]>;
 ...
 */
export type DocumentQuestionAnsweringPipelineCallback = (image: ImageInput, question: string, options?: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType) => Promise<DocumentQuestionAnsweringOutput | DocumentQuestionAnsweringOutput[]>;
...
import { PreTrainedModel } from '@xenova/transformers/src/models.js';
import { PreTrainedTokenizer } from '@xenova/transformers/src/tokenizers.js';
import { Processor } from '@xenova/transformers/src/processors.js';
import { Tensor } from '@xenova/transformers/src/utils/tensor.js';
import { RawImage } from '@xenova/transformers/src/utils/image.js';
...
import { AutoTokenizer } from '@xenova/transformers/src/tokenizers.js';
import { AutoModelForSequenceClassification } from '@xenova/transformers/src/models.js';
import { AutoModelForTokenClassification } from '@xenova/transformers/src/models.js';
import { AutoModelForQuestionAnswering } from '@xenova/transformers/src/models.js';
import { AutoModelForMaskedLM } from '@xenova/transformers/src/models.js';
import { AutoModelForSeq2SeqLM } from '@xenova/transformers/src/models.js';
import { AutoModelForCausalLM } from '@xenova/transformers/src/models.js';
import { AutoModelForAudioClassification } from '@xenova/transformers/src/models.js';
import { AutoProcessor } from '@xenova/transformers/src/processors.js';
import { AutoModel } from '@xenova/transformers/src/models.js';
import { AutoModelForSpeechSeq2Seq } from '@xenova/transformers/src/models.js';
import { AutoModelForTextToSpectrogram } from '@xenova/transformers/src/models.js';
import { AutoModelForTextToWaveform } from '@xenova/transformers/src/models.js';
import { AutoModelForVision2Seq } from '@xenova/transformers/src/models.js';
import { AutoModelForImageClassification } from '@xenova/transformers/src/models.js';
import { AutoModelForImageSegmentation } from '@xenova/transformers/src/models.js';
import { AutoModelForObjectDetection } from '@xenova/transformers/src/models.js';
import { AutoModelForZeroShotObjectDetection } from '@xenova/transformers/src/models.js';
import { AutoModelForDocumentQuestionAnswering } from '@xenova/transformers/src/models.js';
import { AutoModelForImageToImage } from '@xenova/transformers/src/models.js';
import { AutoModelForDepthEstimation } from '@xenova/transformers/src/models.js';
export {};
