...
export class PreTrainedModel extends PreTrainedModel_base {
     ...
     */
    static from_pretrained(pretrained_model_name_or_path: string, { quantized, progress_callback, config, cache_dir, local_files_only, revision, model_file_name, }?: import('@xenova/transformers/src/utils/hub.js').PretrainedOptions): Promise<PreTrainedModel>;
    /**
    ...
    */
     ...
     */
    _get_generation_config(generation_config: import('@xenova/transformers/src/utils/generation.js').GenerationConfigType): import('@xenova/transformers/src/utils/generation.js').GenerationConfigType;
    /**
     ...
     */
    generate(inputs: any[] | import("@xenova/transformers/src/transformers.js").TypedArray | Tensor, generation_config?: any | (new (kwargs?: import("@xenova/transformers/src/utils/generation.js").GenerationConfigType) => import("@xenova/transformers/src/utils/generation.js").GenerationConfigType) | null, logits_processor?: any | null, { inputs_attention_mask }?: {
...
export class T5ForConditionalGeneration extends T5PreTrainedModel {
     ...
     */
    constructor(config: any, session: any, decoder_merged_session: any, generation_config: new (kwargs?: import("@xenova/transformers/src/utils/generation.js").GenerationConfigType) => import("@xenova/transformers/src/utils/generation.js").GenerationConfigType);
    decoder_merged_session: any;
    generation_config: new (kwargs?: import("@xenova/transformers/src/utils/generation.js").GenerationConfigType) => import("@xenova/transformers/src/utils/generation.js").GenerationConfigType;
...
export class GPT2PreTrainedModel extends PreTrainedModel {
     ...
     * @param {GenerationConfig} generation_config The generation configuration.
     */
    constructor(config: any, session: any, generation_config: new (kwargs?: import("@xenova/transformers/src/utils/generation.js").GenerationConfigType) => import("@xenova/transformers/src/utils/generation.js").GenerationConfigType);
    generation_config: new (kwargs?: import("@xenova/transformers/src/utils/generation.js").GenerationConfigType) => import("@xenova/transformers/src/utils/generation.js").GenerationConfigType;
    num_heads: any;
    num_layers: any;
    dim_kv: number;
